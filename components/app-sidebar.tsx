...
import { GalleryVerticalEnd, Plus, Settings, Palette, Bell, User, Shield, HelpCircle, Moon, Sun, Check, Mail, MessageSquare, Calendar, Info, Lock, Key, Eye, Book, FileText, ExternalLink, Save, ChevronRight, Home, MapPin, Image } from "lucide-react"
...
const data = {
  navMain: [
    ...
    },
    {
      ...
      icon: MapPin,
      items: [
        { title: "Overview", url: "/route-vm" },
        { title: "Routes", url: "/route-vm/routes" },
        { title: "Analytics", url: "/route-vm/analytics" },
      ],
    },
    {
      title: "Plano VM",
      ...
      icon: Image,
      items: [
        { title: "Gallery", url: "/plano-vm" },
        { title: "Projects", url: "/plano-vm/projects" },
        { title: "Collections", url: "/plano-vm/collections" },
      ],
    },
  ],
}
  ...
  React.useEffect(() => {
    const fetchRoutes = async () => {
      try {
        ...
        // Update nav data with fetched routes - preserve all items
        setNavData(prevData => {
                ...
                return shouldShowMenu ? (
                  ...
                  >
                    <SidebarMenuItem>
                      ...
                      <CollapsibleContent>
                        <SidebarMenuSub className="ml-3.5 mt-1 space-y-1">
                            ...
                            return (
                              <SidebarMenuSubItem key={subItem.title}>
                                <SidebarMenuSubButton asChild>
                                  <Link href={subItem.url} className="font-medium flex items-center justify-between w-full transition-all duration-200 hover:translate-x-1">
                          ...
                          {/* Add Page Button - Only show in edit mode for Plano VM */}
                          {isEditMode && item.title === "Plano VM" && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton 
                                className="cursor-pointer text-green-600 dark:text-green-400 hover:bg-green-500/10 transition-all duration-200"
                              >
